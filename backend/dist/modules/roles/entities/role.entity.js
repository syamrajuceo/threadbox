...
exports.Role = exports.ProjectRoleType = void 0;
const typeorm_1 = require("typeorm");
const permission_entity_1 = require("./permission.entity");
const membership_entity_1 = require("../../memberships/entities/membership.entity");
var ProjectRoleType;
(function (ProjectRoleType) {
    ProjectRoleType["PROJECT_MANAGER"] = "project_manager";
    ProjectRoleType["DEVELOPER"] = "developer";
    ProjectRoleType["TESTER"] = "tester";
    ProjectRoleType["CUSTOM"] = "custom";
...
__decorate([
    (0, typeorm_1.OneToMany)(() => membership_entity_1.Membership, (membership) => membership.role),
    __metadata("design:type", Array)
], Role.prototype, "memberships", void 0);
